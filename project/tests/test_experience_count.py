...
def test_experience_count():
    ...
    The ProgrammingTool is parent model which has many `ExperienceActivity`
    and many `PersonalSkills`.

    The PersonalSkill model has an `experience_count` method.
    This test verifies that the `experience_count` method correctly counts
    the number of associated `ExperienceActivity` objects through the
    `ProgrammingTool` model.
    """
    ...
    category = Category.objects.create(
        ...
        image=SimpleUploadedFile(
            "django.png", b"file_content", content_type="image/png"
        ),
    )

    # Setup: Create a ProgrammingTool
    tool = ProgrammingTool.objects.create(
        title="Django",
        image=SimpleUploadedFile(
            "django.png", b"file_content", content_type="image/png"
        ),
    ...
    skill = PersonalSkill.objects.create(
        title="Backend Development", programming_tool=tool, category=category
    )
